...
class Galaxy:
    ...
    def display(self):
        ...
        background_image = pygame.image.load('screens/galaxia4.png')
...
class Enemy(MaskedSprite):
    def __init__(self, x, y):
        super().__init__('screens/Ships/ship_0007.png', (60, 60))
        self.rect.center = (x, y)
        self.speed_x = 1
        self.life = 1
        self.float_offset = 0
...
class SpecialEnemy(Enemy):
    def __init__(self, x, y):
        super().__init__(x, y)
        self.image = pygame.image.load('screens/Ships/ship_0014.png')
...
class NewEnemy(Enemy):
    def __init__(self, x, y):
        super().__init__(x, y)
        self.image = pygame.image.load('screens/Ships/ship_0003.png')
